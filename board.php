...
<div class="row-fluid">
        <div class="span4">
            <img style="float: left; padding-right: 10px;" src="assets/img/mfox.jpg">
        ...
        <div class="span4">
                <img style="float: left; padding-right: 10px;" src="assets/img/MarindaWu.jpg" />
	   ...
	   <div class="span4">
       <img style="float: left; padding-right: 10px; height:133px;" src="assets/img/dianne-jacob-s.jpg" />
       <h2>Dianne Jacob*</h2>
...
<div class="row-fluid">
	<div class="span4">
                <img style="float: left; padding-right: 10px;" src="assets/img/JohnCollins.jpg" />
   ...
   <div class="span4">
                <img style="float: left; padding-right: 10px;" src="assets/img/cassen.jpg" />
		<h2>Todd Cassen</h2>
