		...
		<script>(function(d, s, id) {
		  ...
		  fjs.parentNode.insertBefore(js, fjs);
				...
				<div id="homepage-slider" class="carousel slide">
					<div style="cursor: pointer; cursor: hand;" onclick="location.href='/about.php';" class="carousel-inner">
		                                <div class="item active">
                                                        <img width="100%"  src="http://placehold.it/350x150" alt="" />
