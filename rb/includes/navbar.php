        ...
        <div class="navbar navbar-inverse <?php if($page == '/index.php' || $page == '/'){ echo 'transparent navbar-fixed-top'; } else { echo 'navbar-static-top'; } ?>">
            <div class="navbar-inner" >
                <div class="container" style="min-height: 45px; height: 40px;">
                    <a style="padding: 0px;" class="brand" href="index.php">
                    ...
                    <!--					<div class="nav-collapse">-->
                        <ul style="padding-left: 10px; padding-top: 0px;"  class="nav">
                                ...
                                -->
                                <li class="dropdown hidden-phone hidden-tablet">
								<!-- EVEN THOUGH IT IS AN FAQ THE ATTACHMENT FILES ARE NAMED SIGNUP.PHP AS THEY WERE BEFORE PLEASE TAKE THIS INTO NOTICE -->
								
                                <a href="/signup.php"class="dropdown-toggle    <?php if($page == '/signup.php') echo 'active';?>"><i class="icon-envelope icon-white"></i> <big> FAQ</big></a>
                                <ul class="dropdown-menu">
                                ...
                                <a href="#" class="dropdown-toggle   <?php if($page == '/signup.php') echo "active";?>  " data-toggle="dropdown" <?php if ($page == '/signup.php'){ echo 'class="active"'; } ?>><i class="icon-envelope icon-white"></i> <big> QUESTIONS</big></a>
                                <ul class="dropdown-menu">
                                    <li><a href="/signup.php">FAQ:</a></li>
                                    <li><a href="/signup.php#admin">Administrators</a></li>
                                    <li><a href="/signup.php#sponsors">Sponsors</a></li>
							    ...
							    <li><a href="interactive.php"  <?php if($page == '/interactive.php') echo "class='active'";?>  ><i class="icon-user icon-white"></i> <big> INTERACTIVE</big></a></li>
								
								<li><a href="contact.php"  <?php if($page == '/contact.php') echo "class='active'";?>  ><i class="icon-user icon-white"></i> <big> CONTACT US</big></a></li>
